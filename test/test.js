...
describe( 'compute-canberra-distance', function tests() {
	...
	it( 'should compute the Canberra distance', function test() {
	...
	it( 'should compute the Canberra distance using an accessor function', function test() {
		var dat1, dat2, expected, actual;
